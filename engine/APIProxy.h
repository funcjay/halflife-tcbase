...
typedef const struct model_s *		(*pfnEngSrc_GetSpritePointer_t )		( HSPRITE_HL hSprite );
...
typedef void	(*pfnEngDst_pfnSPR_Frames_t )			( HSPRITE_HL * );
typedef void	(*pfnEngDst_pfnSPR_Height_t )			( HSPRITE_HL *, int * );
typedef void	(*pfnEngDst_pfnSPR_Width_t )			( HSPRITE_HL *, int * );
typedef void	(*pfnEngDst_pfnSPR_Set_t )				( HSPRITE_HL *, int *, int *, int * );
...
typedef void	(*pfnEngDst_pfnSetCrosshair_t )			( HSPRITE_HL *, struct rect_s *, int *, int *, int * );
...
typedef void	(*pfnEngDst_GetSpritePointer_t )		( HSPRITE_HL * );
